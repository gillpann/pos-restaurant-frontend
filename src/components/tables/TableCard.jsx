...
const TableCard = ({key, name, status, initials, seats }) => {
  ...
  return (
    <div onClick={handleClick} key={key} className='w-[300px] bg-bg-card p-4 rounded-xl shadow-lg shadow-black/30 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 cursor-pointer'>
